...
- FlashForge Finder, FlashForge Dreamer, FlashForge Dreamer NX, FlashForge Inventor
- PowerSpec Ultra 3D
...
* Turn on debug messages for the plugin (Settings > Logging, under "Logging Levels" set [octoprint.plugins.flashforge](./wiki/images/LoggingSettings.png) to "DEBUG" and then click "Save") to help troubleshoot connection issues.
